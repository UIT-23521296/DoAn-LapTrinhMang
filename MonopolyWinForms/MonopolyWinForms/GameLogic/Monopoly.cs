...
namespace MonopolyWinForms.GameLogic
{
    class Monopoly
    {
        ...
        {
            return tiles.Count(t => t.PlayerId == playerId && t.MonoGroup == monoGroup);
        }

        // Trả về tổng số ô trong nhóm MonoGroup
        public int TotalTilesInGroup(string monoGroup)
        {
            return tiles.Count(t => t.MonoGroup == monoGroup);
        }
        ...
        {
            var groups = tiles.Select(t => t.MonoGroup).Distinct();
        ...
        public int CountBusesOwned(int playerId)
        {
            ...
            return tiles.Count(t => t.PlayerId == playerId && t.MonoGroup == "1");
        }
